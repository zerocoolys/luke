...
public class Util {
	...
	public static String normsToString(BinaryDocValues norms, String fName, int docid, TFIDFSimilarity sim) {
		if (norms == null) {
			return "-?-";
		}
	...
	public static String normsToString(SortedDocValues norms, String fName, int docid, TFIDFSimilarity sim) {
		if (norms == null) {
			return "-?-";
		}
		BytesRef ref = new BytesRef();
	...
	//	public static String normsToString(SortedSetDocValues norms, String fName, int docid, TFIDFSimilarity sim) {
	//		if (norms == null) {
	//			return "-?-";
	//		}
	//		BytesRef ref = new BytesRef();
